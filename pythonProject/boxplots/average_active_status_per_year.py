...
# Calculate average total missions per year
average_total_missions_per_year = data_df.groupby('Year')['Active_Status_Count'].mean()
...
boxplot = axes.boxplot(average_total_missions_per_year, vert=False, widths=0.7)
...
axes.set_xlabel('Average Number of Rockets still active per Year')
axes.set_title('Boxplot of Average Rockets still active per Year')
