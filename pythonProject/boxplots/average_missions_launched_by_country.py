...
# Calculate average total missions, successful missions, and failed missions per country
average_total_missions_per_country = data_df.groupby('Country')['Total_Missions'].mean()
average_successful_missions_per_country = data_df.groupby('Country')['Successful_Missions'].mean()
average_failed_missions_per_country = data_df.groupby('Country')['Failed_Missions'].mean()
...
# Plot boxplot for average total missions per country
boxplot_total = axes[0].boxplot(average_total_missions_per_country, vert=False, widths=0.7)
...
# Plot boxplot for average successful missions per country
boxplot_successful = axes[1].boxplot(average_successful_missions_per_country, vert=False, widths=0.7)
...
# Plot boxplot for average failed missions per country
boxplot_failed = axes[2].boxplot(average_failed_missions_per_country, vert=False, widths=0.7)
