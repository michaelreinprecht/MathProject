...
ax1.bar(data_df['Country'], data_df['Active_Status_Count'], color='skyblue')
ax1.set_ylabel('Active Status Count')
ax1.set_title('Active Status Count by Country')
...
ax2.bar(data_df['Country'], data_df['Active_Status_Relative'], color='salmon')
ax2.set_ylabel('Active Status Relative')
ax2.set_title('Active Status Relative by Country')
