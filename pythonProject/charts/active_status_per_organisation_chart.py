...
ax1.bar(data_df['Organisation'], data_df['Active_Status_Count'], color='skyblue')
ax1.set_ylabel('Active Status Count')
ax1.set_title('Active Status Count by Organisation')
...
ax2.bar(data_df['Organisation'], data_df['Active_Status_Relative'], color='salmon')
ax2.set_ylabel('Active Status Relative')
ax2.set_title('Active Status Relative by Organisation')
