...
# Define the countries and values to plot
countries = data_df['Country']
missions = [
...
for mission in missions:
    ...
    # Plot absolute value
    ax = axes[0]
    ax.bar(countries, data_df[absolute_value], color='skyblue')
    ...
    ax.set_xticklabels(countries, rotation=90)  # Rotate labels by 90 degrees

    # Plot relative value
    ax = axes[1]
    ax.bar(countries, data_df[relative_value], color='skyblue')
